...
namespace HeatGamesCore.Services.Interfaces
{
    ...
    {
        Task<(IEnumerable<GameDto> Games, int TotalCount)> GetAllGamesAsync(string? searchQuery = null, string? genre = null, decimal? maxPrice = null, int page = 1, int pageSize = 8);
