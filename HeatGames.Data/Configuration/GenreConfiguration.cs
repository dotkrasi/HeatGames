    ...
    public class GenreConfiguration : IEntityTypeConfiguration<Genre>
    {
        public void Configure(EntityTypeBuilder<Genre> builder)
        {
            builder.HasData(
                ...
                new Genre { Id = Guid.Parse("33333333-3333-3333-3333-333333333333"), Name = "Shooter" },
                new Genre { Id = Guid.Parse("44444444-4444-4444-4444-444444444444"), Name = "Strategy" },
                new Genre { Id = Guid.Parse("55555555-5555-5555-5555-555555555555"), Name = "Adventure" },
                new Genre { Id = Guid.Parse("66666666-6666-6666-6666-666666666666"), Name = "Indie" }
            );
        }
    }
}